...
module TASKMAN
	...
	class Theme::Window::Main::Status < Vbox
		...
		def initialize arg= {}
			...
			h1= Hbox.new( :name=> 'status_display', '.display'=> 1)
			...
			h2= Hbox.new( :name=> 'status_prompt', '.display'=> 0)
			h2<< Label.new( :name=> "#{@name}_question",  '.expand'=> '0', :text=> '')
			h2<< Label.new( :name => 'space4', '.expand' => '0', :text => ' ')
			pa= Theme::MenuAction.new( :name=> 'handle_answer', :hotkey=> 'ENTER')
